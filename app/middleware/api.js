...
const API_ROOT = 'http://192.168.0.68:3004/';
//const API_ROOT = 'http://211.159.153.23:3003/';
...
function callApi(endpoint, schema, method, body) {
    ...
    var fullUrl = (endpoint.indexOf(API_ROOT) === -1) ? API_ROOT + httpUrl : endpoint
        ...
        //     var sign = "/" + httpUrl + reqQuery + encodeURI(_body) + 'ABCDEFG$';
...
// const jsonToExcleSchema = new Schema('no');
const fetSchema = new Schema('no');
